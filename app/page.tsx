...
export default function Home() {
  return (
    <div className="bg-black min-h-screen text-white font-mono selection:bg-white selection:text-black">
      ...
      {/* SECTION 3 — DEMO */}
      <section id="demo" className="py-24 border-t border-white/10 relative px-6">
        <div className="absolute top-0 left-0 w-12 h-12 border-t-2 border-l-2 border-white/30" />
        <div className="absolute top-0 right-0 w-12 h-12 border-t-2 border-r-2 border-white/30" />
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-2 mb-4 opacity-60">
             <div className="w-12 h-px bg-white"/>
             <span className="text-[10px] font-mono">02 // LIVE FEED</span>
             <div className="w-12 h-px bg-white"/>
          </div>
          <h2 className="font-mono text-4xl font-bold text-white tracking-widest mb-2">QUERY THE SYSTEM</h2>
          <p className="text-white/50 text-xs tracking-widest mb-12">LIVE DEMONSTRATION — INTELLIGENCE STREAMING</p>
          <AnimatedAIChat />
        </div>
      </section>

      {/* SECTION 4 — FEATURES */}
      <section className="py-24 border-t border-white/10 relative px-6">
        <div className="absolute top-0 left-0 w-12 h-12 border-t-2 border-l-2 border-white/30" />
        <div className="absolute top-0 right-0 w-12 h-12 border-t-2 border-r-2 border-white/30" />
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="font-mono text-3xl font-bold text-white tracking-widest mb-12 text-center">INTELLIGENCE MODULES</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-black border border-white/20 p-8 relative group hover:border-white/50 transition-colors col-span-1 md:col-span-2">
              ...
              <h3 className="text-xl font-bold mb-4 tracking-wider">DARK PSYCHOLOGY</h3>
              <p className="text-white/60 text-sm leading-relaxed">Reverse-engineer manipulation tactics, influence frameworks, and the science of mass persuasion used by media and state actors.</p>
            </div>
            ...
            <div className="bg-black border border-white/20 p-8 relative group hover:border-white/50 transition-colors col-span-1 md:col-span-2">
              ...
              <h3 className="text-xl font-bold mb-4 tracking-wider">SUPPRESSED SYSTEMS</h3>
              <p className="text-white/60 text-sm leading-relaxed">Deep structural analysis into financial warfare, suppressed technologies, and modern geopolitical control grids.</p>
            </div>

            <div className="bg-black border border-white/20 p-8 relative group hover:border-white/50 transition-colors">
              <div className="text-white/40 text-[10px] mb-4">[ 01 ]</div>
              <h3 className="text-lg font-bold mb-2 tracking-wider">ENCRYPTED MEMORY</h3>
              <p className="text-white/60 text-xs">Supabase RLS secures all session logs permanently.</p>
            </div>

            <div className="bg-black border border-white/20 p-8 relative group hover:border-white/50 transition-colors">
              <div className="text-white/40 text-[10px] mb-4">[ 02 ]</div>
              <h3 className="text-lg font-bold mb-2 tracking-wider">LLAMA-3.3 70B</h3>
              <p className="text-white/60 text-xs">Powered by the largest open-weights model for hyper-accurate logic.</p>
            </div>
            
            <div className="bg-black border border-white/20 p-8 relative group hover:border-white/50 transition-colors md:col-span-2 flex items-center justify-between overflow-hidden">
               <div className="relative z-10 w-full">
                  ...
                  <h3 className="text-lg font-bold mb-2 tracking-wider">GROQ LPU STREAMING</h3>
      ...
      {/* SECTION 5 — CTA */}
      <section className="py-32 text-center border-t border-white/10 relative px-6 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-12 h-12 border-t-2 border-l-2 border-white/30" />
        <div className="absolute top-0 right-0 w-12 h-12 border-t-2 border-r-2 border-white/30" />
        <div className="absolute bottom-0 left-0 w-12 h-12 border-b-2 border-l-2 border-white/30 relative z-10" />
        <div className="absolute bottom-0 right-0 w-12 h-12 border-b-2 border-r-2 border-white/30 relative z-10" />
        
        <div className="relative z-10 max-w-2xl mx-auto">
           <h2 className="font-mono text-4xl md:text-6xl font-bold text-white mb-6 tracking-widest">INITIATE ACCESS</h2>
           <p className="font-mono text-white/50 text-sm mb-12">The system is ready. Awaiting your credentials.</p>
           
           <Link href="/auth" className="inline-block border border-white bg-white text-black hover:bg-black hover:text-white font-mono px-12 py-4 tracking-widest transition-all font-bold relative group">
             <span className="absolute -top-2 -left-2 w-4 h-4 border-t-2 border-l-2 border-white opacity-0 group-hover:opacity-100 transition-all group-hover:-top-3 group-hover:-left-3" />
             <span className="absolute -bottom-2 -right-2 w-4 h-4 border-b-2 border-r-2 border-white opacity-0 group-hover:opacity-100 transition-all group-hover:-bottom-3 group-hover:-right-3" />
